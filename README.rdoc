...
* How to run the test suite
  * Use the command: #bundle exec rake test:models to run the test cases of models created
  *  Use the command: #bundle exec rake test to run all the test cases related to app (controller, model,view).
...
* Deployment instructions
  ...
  * First Get the heroku login and create an app using following commands
    *heroku create
  * Git add and commit
